    ...
    <div className="flex min-h-screen bg-transparent text-foreground font-sans antialiased">
      ...
      <div className="flex-1 flex flex-col min-w-0 min-h-screen pb-0">
        ...
        <main className="flex-1 overflow-y-auto p-1.5 sm:p-2.5 md:p-3.5 lg:p-6 flex flex-col justify-start">
          ...
          <div
            className={cn(
              "w-full mx-auto bg-white/70 dark:bg-slate-900/50 border border-black/5 dark:border-white/10 rounded-xl md:rounded-2xl lg:rounded-3xl p-2.5 sm:p-3.5 md:p-4 lg:p-6 transition-all duration-300",
