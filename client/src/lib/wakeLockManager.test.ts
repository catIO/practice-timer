...
import { requestWakeLock, releaseWakeLock, isWakeLockActive } from './wakeLockManager';
...
describe('wakeLockManager', () => {
  ...
  it('handles environment where native wakeLock is unsupported gracefully without crashing', async () => {
    Object.defineProperty(navigator, 'wakeLock', {
      value: undefined,
      configurable: true,
      writable: true
